...
import { adjustTimer,adjustTimer1,isRunnigSet, timerReset, timerSet, timerTic, workSessionToggle } from "./slicesReducer/timerSlice";
import { breaksAdjuster, breaksAdjuster1, breaksReset, breaksSet, breaksTic } from "./slicesReducer/breakSlice";
        ...
        <section className="ControlInterface">
            ...
            <div className="ControlSpace">
                <div className="ControlZone">
                    ...
                    <input type="range" min={10} max={60} value={timer.length} onChange={e=>dispatch(adjustTimer1(e.target.value))}/>
                        <span style={{ width: `${((timer.length - 10) / (60 - 10)) * 89.5 + 10.5}%` }}></span>
                        <div className="names">
                            <p>10</p>
                ...
                <div className="ControlZone">
                    ...
                    <div className="progresse">
                    <input type="range" min={1} max={10} value={breaks.length} onChange={e=>dispatch(breaksAdjuster1(e.target.value))}/>
